...
var hemlight = new THREE.DirectionalLight(0xFFFFFF, 0.4);
hemlight.position.set(0.5,0,0.8)
var root = new THREE.Object3D();
root.add(hemlight)
root.add(iglight);
root.add( new THREE.AmbientLight( 0x040404 ) );
scene.add(root);
...
segnaposto=0
    ...
    polOBJ.rotation.set(0,-pmezzi,0)
    polOBJ.scale.set(cilscale.x*5,cilscale.y*5,cilscale.z*5);
    polOBJ.name = "pol";
    volti.add(polOBJ);
